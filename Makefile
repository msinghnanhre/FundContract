...
deploy-sepolia:
	forge script script/DeployFundMe.js:DeployFundMe --rpc-url $(SEPOLIA_URL) --private-key $(SEPOLIA_PRIVATE_KEY) --broadbast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
